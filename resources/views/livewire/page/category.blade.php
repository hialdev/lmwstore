<div>
    ...
    <div class="container-fluid py-5">
        ...
        <input type="search" class="form-control" wire:model="q" placeholder="Search product ..." required>
        <hr>
        <div class="toolbox">
        ...
        <div class="products">
            <div class="row">
                ...
                <div class="text-center p-3 bg-light">
                    ...
                    Silahkan masukan kata kunci lain atau <a href="{{route('product')}}">cari disemua kategori</a>
                </div>
                @endforelse
