<div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-3">
        ...
        <div class="mt-3 ms-auto">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Tambah FAQ</a>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
        <div class="w-100 mb-3">
            <input wire:model="q" type="search" class="form-control" placeholder="Cari FAQ..">
        </div>
        @if ($q === null)
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mb-3">
                            <label for="inputtitle">Title FAQ</label>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mb-3">
                            <label for="inputplatform">Title FAQ</label>
                            <input wire:model="title" type="text" class="form-control" id="inputplatform" value="{{$title}}">
                            @error('title') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                        <div wire:ignore class="form-group mb-3">
                            <label class="col-form-label" for="editor">Deskripsi Lengkap</label>
        ...
        <table class="table mb-0 table-md">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$f->title}}</td>
                    <td><div class="crop-4">{{$f->desc}}</div></td>
                    <td>
