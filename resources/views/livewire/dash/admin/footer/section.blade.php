<div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-3">
        <div>
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Footer Section</li>
                </ol>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <h3 class="m-0">Footer Section</h3>
            </div>
        </div>
        <div class="mt-3 ms-auto">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Tambah Page</a>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
        <div class="w-100 mb-3">
            <input wire:model="q" type="search" class="form-control" placeholder="Cari Footer Section..">
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Section</h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mb-3">
                            <label for="inputNama">Nama Footer Section</label>
                            <input wire:model="section" type="text" class="form-control" id="inputNama">
                            @error('section') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                    </form>
                </div>
    ...
    <div wire:ignore.self class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Edit Section</h5>
                    <button type="button" class="close" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i data-feather="x"></i>
                    </button>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mb-3">
                            <label for="inputNama">Nama Footer Section</label>
                            <input wire:model="section" type="text" class="form-control" id="inputNama" value="{{$section}}">
                            @error('section') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                    </form>
                </div>
